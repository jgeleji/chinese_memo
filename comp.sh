...
g++ input.cpp main_characters.cpp tokenize.cpp questions.cpp -lncurses -o characters
g++ input.cpp main_characters_easy.cpp tokenize.cpp questions.cpp -lncurses -o characters_easy
